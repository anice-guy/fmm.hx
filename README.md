# funky clone
a [Funky Maker: Mobile](https://play.google.com/store/apps/details?id=com.kingamescreator.fnmm) level player made on HaxeFlixel
...
it could be considered the spiritual succesor to [Friday Night Maker](https://kingamescreator.itch.io/friday-night-maker)
...
* proper build tools (gcc, msvc, etc...)
